...
computers_programming = M.fromList [("programming language", 1.1), ("program programming", 1.75), ("scheme program", 1.75), ("lisp scheme", 1.75), ("scala lisp", 1.75), ("java scala", 1.75), ("lisp java", 1.75), ("java lisp", 1.75), ("debugging java", 1.75), ("debug debugging", 1.75), ("logic debug", 1.75), ("netbeans logic", 1.75), ("intellij netbeans", 1.75), ("eclipse intellij", 1.75), ("ide eclipse", 1.75), ("compilers ide", 1.75), ("compiler compilers", 1.75), ("programming compiler", 1.5), ("pl pl", 1.3), ("computer programs", 1.1), ("iso iec", 1.1), ("software development", 0.85), ("online easily", 0.85), ("virusfree online", 0.85), ("virusfree programming", 0.85), ("understand something", 0.65), ("visual basic", 0.65), ("easily convert", 0.65), ("online converter", 0.65), ("volley spheres", 0.65), ("full source", 0.65)]
