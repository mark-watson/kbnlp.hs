...
religion_christianity = M.fromList [("are funny", 1.1), ("lefties are", 1.05), ("jesus christ", 0.8), ("liberal christian", 0.5), ("this paranoia", 0.5), ("comes this", 0.5), ("whence comes", 0.5)]
religion_hinduism = M.fromList [("stories episodes", 0.55), ("upanishad stories", 0.5)]
