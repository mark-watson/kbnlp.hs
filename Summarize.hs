...
main = do     
  let s = "Plunging European stocks, wobbly bonds and grave concerns about the health of Portuguese lender Banco Espírito Santo SA made last week feel like a rerun of the euro crisis, but most investors say it was no more than a blip for a resurgent region. Banco Espírito Santo has been in investors’ sights since December, when The Wall Street Journal first reported on accounting irregularities at the complex firm. Nerves frayed on Thursday when Banco Espírito Santo’s parent company said it wouldn’t be able to meet some short-term debt obligations."
  print $ summarize s
  print $ summarize_s s
